...
python tampermonkey/pruebas/qa_estricto.py ABCEFGHIJKLMNOQRT # sin escribir (sin RMD_PRUEBA usa el RMD Ingresado 2202609081)
```
...
```bash
python tampermonkey/pruebas/qa_local.py           # aviso sin guardar, predecesor obligatorio, texto "CONTROL DE CALIDAD...", PM OP (LN6), redacción "En minúsculas" (LN7), "Aa" con pH/mL en "Editar Paso" (LN8), biocarga (LN9), orden de estructuras (LN10) y ventana raíz sin cambios de tamaño (LN11)
