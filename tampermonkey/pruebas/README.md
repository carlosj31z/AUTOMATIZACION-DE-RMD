...
Las mejoras añadidas en v1.11-1.13 (botón "Nuevo Paso" en el selector "Adicionar Pasos", "Ver todas"/"Exportar a CSV" en "Ver OP" recorriendo la paginación real del servidor, nomenclatura de Observaciones en Asociar Fórmula, "Documentos citados", y las dos experimentales de texto en mayúsculas) se comprobaron a mano contra el portal real (capturas y lectura del DOM), sin escribir nada, pero **no tienen todavía un bloque propio** en `qa_estricto.py` como H/I/J/K/L/M/N.
