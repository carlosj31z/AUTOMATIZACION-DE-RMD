...
```bash
python tampermonkey/pruebas/qa_local.py           # aviso sin guardar, predecesor obligatorio, texto "CONTROL DE CALIDAD...", PM OP (LN6), redacción "En minúsculas" (LN7), "Aa" con pH/mL en "Editar Paso" (LN8) y biocarga (LN9)
